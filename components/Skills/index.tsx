  ...
  return (
    <div className="w-full group h-52 overflow-hidden relative cursor-pointer rounded-2xl bg-switch-light dark:bg-switch-dark flex justify-center items-center">
      <img
        ...
        alt={alt}
      />
      <div className="absolute w-full h-full inset-0 flex flex-col text-center justify-center bg-orange-light dark:bg-orange-dark translate-y-[110%] group-hover:translate-y-0 transition-all duration-300 ease-in-out">

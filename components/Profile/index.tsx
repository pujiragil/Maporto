...
const Experience = () => {
  return (
    <div className="py-2 md:py-2.5 flex justify-center items-center gap-3 w-full md:gap-8 lg:justify-evenly lg:w-6/12 text-primary-two dark:text-secondary-two">
      <div className="text-center max-w-[105px] md:max-w-[125px] lg:max-w-[130px]">
